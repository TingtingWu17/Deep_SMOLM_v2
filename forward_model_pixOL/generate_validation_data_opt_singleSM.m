...
% ********************************
save_folder = 'C:\Users\wu.t\OneDrive - Washington University in St. Louis\github\data for Deep-SMOLM\validation_20210331_1SM_fixed\'; 
% ********************************
...
x_SMs = (0.9999*rand(1)-1/2)/upsampling_ratio; %x location, in unit of pixles
y_SMs = (0.9999*rand(1)-1/2)/upsampling_ratio;%y location, in unit of pixles
