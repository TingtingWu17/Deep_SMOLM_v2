...
save_folder = '/home/wut/Documents/Deep-SMOLM/data/opt_PSF_data_1000vs2/phantom_20220715_dense_SMs_1000vs2_pixOL/'; 
% ********************************
...
z_SMs = (rand(1,n_SMs)*200-100)/pixel_size_z*0;
...
bkg_img = [ones(image_size,image_size)*background_avg,ones(image_size,image_size)*background_avg];
