...
class MicroscopyDataLoader():
    ...
    def __getitem__(self,idx): # idx: index of the batches
        ...
        if self.GT_image_name=="":
            ...
            XX,YY,ZZ,XY,XZ,YZ = GT_channel[2:3,:,:],GT_channel[3:4,:,:],GT_channel[4:5,:,:],GT_channel[5:6,:,:],GT_channel[6:7,:,:],GT_channel[7:8,:,:]
            #sXX,sYY,sZZ,sXY,sXZ,sYZ = GT_channel[8:9,:,:],GT_channel[9:10,:,:],GT_channel[10:11,:,:],GT_channel[11:12,:,:],GT_channel[12:13,:,:],GT_channel[13:14,:,:]
            
            

        Output_channel = np.concatenate((intensity_gaussian,XX,YY,ZZ,XY,XZ,YZ), axis = 0)    
