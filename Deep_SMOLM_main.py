...
if __name__ == '__main__':
    ...
    args.add_argument('-r', '--resume', default='/home/wut/Documents/Deep-SMOLM/data/save/models/training_with_retrieve_pixOL_com_sym_89/0622_172634/model_best.pth', type=str,
